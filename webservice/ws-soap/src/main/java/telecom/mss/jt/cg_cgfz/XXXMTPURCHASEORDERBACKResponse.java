...
/**
 * <p>XXX_MT_PURCHASE_ORDER_BACKResponse complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="XXX_MT_PURCHASE_ORDER_BACKResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "XXX_MT_PURCHASE_ORDER_BACKResponse", propOrder = {
    "eresponse"
})
public class XXXMTPURCHASEORDERBACKResponse {
